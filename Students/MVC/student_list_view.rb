...
class Student_list_view < FXVerticalFrame
  ...
  def populate_table
    data_list = Data_list_student.new([
      Student.new(last_name: "Решетка", first_name: "Даниил", patronymic_name: "Владимирович", git: "test1", id: 0, telegram: "@testtt1", birth_date: "01.01.1995", email: "wysi727@gmail.com", phone: "88005553535"),
      Student.new(last_name: "Арешетка", first_name: "Баниил", patronymic_name: "Младимирович", git: "test2", id: 1, telegram: "@testtt2", birth_date: "02.01.1995", email: "wysi728@gmail.com", phone: "88005553536"),
      Student.new(last_name: "Брешетка", first_name: "Раниил", patronymic_name: "Уладимирович", git: "test3", id: 1, telegram: "@testtt3", birth_date: "03.01.1995", email: "wysi729@gmail.com", phone: "88005553537"),
    ])
